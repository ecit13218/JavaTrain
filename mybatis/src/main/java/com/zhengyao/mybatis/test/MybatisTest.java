package com.zhengyao.mybatis.test;

import com.zhengyao.mybatis.dao.IUserDao;
...
public class MybatisTest {
    ...
    public void test1() throws IOException {
        ...
        List<User> users = sqlSession.selectList("com.zhengyao.mybatis.dao.IUserDao.findAll");
        for (User user : users) {
...
//    </foreach>
    ...
    public void test4() throws IOException {
        ...
        sqlSession.delete("com.zhengyao.mybatis.dao.IUserDao.deleteUser",6);
        sqlSession.commit();
